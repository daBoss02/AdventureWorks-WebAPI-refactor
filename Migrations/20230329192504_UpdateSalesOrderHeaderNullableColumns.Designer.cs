...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230329192504_UpdateSalesOrderHeaderNullableColumns")]
    partial class UpdateSalesOrderHeaderNullableColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("WebApplication1.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplication1.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("WebApplication1.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.Product", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductCategory", b =>
                {
                    b.HasOne("WebApplication1.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("WebApplication1.Models.SalesOrderDetail", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("WebApplication1.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("WebApplication1.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("WebApplication1.Models.Address", "ShipToAddress")
